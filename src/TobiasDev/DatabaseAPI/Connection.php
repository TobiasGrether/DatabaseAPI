<?php
	 ...
	 class Connection
	 {
		  ...
		  /**
			...
			*/
		  public function executeQuery ( String $query, String $database, \Closure $datahandler = null, \Closure $action = null, array $data = [])
		  {

				DatabaseAPI::getInstance()->getServer()->getAsyncPool()->submitTask(new SelectorTask( $query, $this, $datahandler, $action, $database , $data) );
		  }
